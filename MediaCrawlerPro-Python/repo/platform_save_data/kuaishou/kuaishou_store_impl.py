...
class KuaishouCsvStoreImplement(AbstractStore):
    ...
    # 缓存时间戳，确保同一次爬取任务的所有数据保存到同一个文件
    _cached_time: str = f"{utils.get_current_date()}_{utils.get_current_time_hms()}"
    ...
    def make_save_file_name(self, store_type: str) -> str:
        ...
        Returns: eg: data/kuaishou/1_search_contents_2024-01-14_14-30-45.csv ...

        """
        return f"{self.csv_store_path}/{self.file_count}_{crawler_type_var.get()}_{store_type}_{self._cached_time}.csv"
