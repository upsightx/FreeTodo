...
# Repository: https://github.com/MediaCrawlerPro/MediaCrawlerPro-Python/blob/main/pkg/file_header_manager.py
...
# 项目配置
REPO_URL = "https://github.com/MediaCrawlerPro/MediaCrawlerPro-Python"
...
def has_copyright_header(content: str) -> bool:
    ...
    """
    # 检查是否包含Copyright关键字
    return "Copyright (c)" in content and "MediaCrawlerPro-Python project" in content
