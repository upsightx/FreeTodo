...
/// Set to true to run against your own LifeTrace Center instead of omi cloud.
const bool _kLifeTraceMode = true;

Future _init() async {
  // Env
  if (_kLifeTraceMode) {
    Env.init(const LifeTraceEnv());
    LifeTraceEnv.enabled = true;
  ...
  if (_kLifeTraceMode) {
    SharedPreferencesUtil().uid = LifeTraceEnv.lifetraceUid;
    SharedPreferencesUtil().authToken = LifeTraceEnv.lifetraceToken;
