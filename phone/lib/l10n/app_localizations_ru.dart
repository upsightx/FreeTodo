...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get createPersonHint => 'Создайте нового человека и обучите FreeU распознавать его голос тоже!';
  ...
  @override
  String get askOmi => 'Спросить FreeU';
  ...
  @override
  String get deletingMessages => 'Удаление ваших сообщений из памяти FreeU...';
  ...
  @override
  String get getOmiForMac => 'Получить FreeU для Mac';
  ...
  String get privacyIntro =>
      'В FreeU мы стремимся защитить вашу конфиденциальность. Эта страница позволяет вам контролировать, как хранятся и используются ваши данные.';
  ...
  @override
  String get deviceDisconnectedMessage => 'Ваш FreeU был отключён 😔';
  ...
  @override
  String get connectDeviceMessage => 'Подключите устройство FreeU для доступа\nк настройкам устройства и настройке';
  ...
  String get startConversationToSeeInsights =>
      'Начните разговор с FreeU,\nчтобы увидеть здесь вашу статистику использования.';

  @override
  String get listening => 'Прослушивание';

  @override
  String get listeningSubtitle => 'Общее время активного прослушивания FreeU.';
  ...
  @override
  String get shareStatsMessage => 'Делюсь статистикой FreeU! (FreeU.me - ваш постоянный AI-помощник)';

  @override
  String get sharePeriodToday => 'Сегодня FreeU:';

  @override
  String get sharePeriodMonth => 'В этом месяце FreeU:';

  @override
  String get sharePeriodYear => 'В этом году FreeU:';

  @override
  String get sharePeriodAllTime => 'За всё время FreeU:';
  ...
  @override
  String get omiDebugLog => 'Журнал отладки FreeU';
  ...
  @override
  String get exportedConversations => 'Экспортированные разговоры из FreeU';
  ...
  String authAccessMessage(String appName) {
    return 'Вам нужно авторизовать FreeU для доступа к вашим данным $appName. Это откроет браузер для аутентификации.';
  }
  ...
  @override
  String get howShouldOmiCallYou => 'Как FreeU должен вас называть?';
  ...
  String authorizeOmiForTasks(String appName) {
    return 'Вам нужно авторизовать FreeU для создания задач в вашем аккаунте $appName. Это откроет браузер для аутентификации.';
  }
  ...
  @override
  String get payYourSttProvider => 'Свободно используйте FreeU. Вы платите только своему провайдеру STT напрямую.';
  ...
  String deviceUsesCodec(String device, String reason) {
    return '$device использует $reason. Будет использован FreeU.';
  }

  @override
  String get omiTranscription => 'Расшифровка FreeU';
  ...
  String get bluetoothNeeded =>
      'FreeU требуется Bluetooth для подключения к вашему устройству. Пожалуйста, включите Bluetooth и попробуйте снова.';
  ...
  @override
  String get backgroundActivityDesc => 'Позвольте FreeU работать в фоновом режиме для лучшей стабильности';
  ...
  @override
  String get lovingOmi => 'Нравится FreeU?';
  ...
  @override
  String get speechProfileIntro => 'FreeU нужно узнать ваши цели и ваш голос. Вы сможете изменить это позже.';
  ...
  @override
  String get connectOmiOmiGlass => 'Подключить FreeU / OmiGlass';
  ...
  @override
  String get omiYourAiCompanion => 'FreeU – ваш AI-компаньон';
  ...
  String get permissionGrantedNow =>
      'Разрешение предоставлено! Теперь:\n\nОткройте приложение FreeU на ваших часах и нажмите \"Продолжить\" ниже';
  ...
  @override
  String get clearMemoryTitle => 'Очистить память FreeU';

  @override
  String get clearMemoryMessage => 'Вы уверены, что хотите очистить память FreeU? Это действие нельзя отменить.';

  @override
  String get clearMemoryButton => 'Очистить память';

  @override
  String get memoryClearedSuccess => 'Память FreeU о вас была очищена';
  ...
  String get translationNoticeMessage =>
      'FreeU переводит разговоры на ваш основной язык. Обновите его в любое время в Настройки → Профили.';
  ...
  @override
  String get omiSyncsAudioFiles => 'FreeU затем синхронизирует аудиофайлы с сервером';
  ...
  String get welcomeToOmiDescription =>
      'Добро пожаловать в FreeU! Ваш AI-компаньон готов помочь вам с разговорами, задачами и многим другим.';

  @override
  String get startUsingOmi => 'Начать использовать FreeU';
  ...
  String get startCapturingConversations =>
      'Начните записывать разговоры с помощью устройства FreeU, чтобы увидеть их здесь.';
  ...
  @override
  String get noTasksForToday => 'Нет задач на сегодня.\\nСпросите FreeU о дополнительных задачах или создайте вручную.';
  ...
  @override
  String get buildSubmitCustomOmiApp => 'Создайте и отправьте свое пользовательское приложение FreeU';
  ...
  String get submitAppTermsAgreement =>
      'Отправляя это приложение, я принимаю Условия использования и Политику конфиденциальности FreeU AI';
  ...
  String get dataAccessWarning =>
      'Это приложение получит доступ к вашим данным. FreeU AI не несет ответственности за то, как ваши данные используются, изменяются или удаляются этим приложением';
  ...
  @override
  String get getOmiDevice => 'Получить устройство FreeU';
  ...
  @override
  String get permanentlyRemoveAllMemories => 'Навсегда удалить все воспоминания из FreeU';
  ...
  @override
  String get clearOmisMemory => 'Очистить память FreeU';

  @override
  String clearMemoryConfirmation(int count) {
    return 'Вы уверены, что хотите очистить память FreeU? Это действие нельзя отменить, и оно навсегда удалит все $count воспоминаний.';
  }

  @override
  String get omisMemoryCleared => 'Память FreeU о вас была очищена';

  @override
  String get welcomeToOmi => 'Добро пожаловать в FreeU';
  ...
  @override
  String get selectPreferredLanguageForBestExperience => 'Выберите предпочитаемый язык для наилучшего опыта FreeU';
  ...
  String get tellUsHowYouWouldLikeToBeAddressed =>
      'Скажите нам, как вы хотели бы, чтобы к вам обращались. Это помогает персонализировать ваш опыт FreeU.';
  ...
  @override
  String get enableFeaturesForBestExperience => 'Включите функции для наилучшего опыта FreeU на вашем устройстве.';
  ...
  String get microphoneAccessDescription =>
      'FreeU нужен доступ к микрофону для записи ваших разговоров и предоставления транскрипций.';
  ...
  String get screenRecordingDescription =>
      'FreeU нужно разрешение на запись экрана для захвата системного звука с ваших встреч на базе браузера.';
  ...
  String get accessibilityDescription =>
      'FreeU нужно разрешение доступности для обнаружения, когда вы присоединяетесь к встречам Zoom, Meet или Teams в вашем браузере.';
  ...
  @override
  String get manageYourOmiPersona => 'Управление вашей персоной FreeU';

  @override
  String get voiceAndPeople => 'Голос и Люди';

  @override
  String get teachOmiYourVoice => 'Научите FreeU вашему голосу';

  @override
  String get tellOmiWhoSaidIt => 'Скажите FreeU, кто это сказал 🗣️';
  ...
  @override
  String get helpImproveOmiBySharing => 'Помогите улучшить FreeU, делясь анонимными аналитическими данными';
  ...
  String get mcpDescription =>
      'Для подключения FreeU к другим приложениям для чтения, поиска и управления вашими воспоминаниями и беседами. Создайте ключ для начала.';
  ...
  @override
  String get tryLatestExperimentalFeatures => 'Попробуйте новейшие экспериментальные функции от команды FreeU.';
  ...
  @override
  String get letOmiChooseAutomatically => 'Позвольте FreeU автоматически выбрать лучшее приложение';
  ...
  @override
  String get translatedByOmi => 'переведено FreeU';
  ...
  @override
  String get addWordsDescription => 'Добавьте слова, которые FreeU должен распознавать во время транскрипции.';
  ...
  @override
  String get connectOmiWithAI => 'Подключите FreeU к ИИ-ассистентам';
  ...
  @override
  String get omiApiKeys => 'API-ключи FreeU';

  @override
  String get apiKeysDescription =>
      'API-ключи используются для аутентификации, когда ваше приложение взаимодействует с сервером FreeU. Они позволяют вашему приложению создавать воспоминания и безопасно получать доступ к другим сервисам FreeU.';

  @override
  String get aboutOmiApiKeys => 'Об API-ключах FreeU';
  ...
  String get e2eeDescription =>
      'Сквозное шифрование — это золотой стандарт конфиденциальности. При включении ваши данные шифруются на вашем устройстве перед отправкой на наши серверы. Это означает, что никто, даже FreeU, не может получить доступ к вашему контенту.';
  ...
  String get secureEncryptionDescription =>
      'Ваши данные шифруются уникальным для вас ключом на наших серверах, размещенных в Google Cloud. Это означает, что ваш необработанный контент недоступен никому, включая сотрудников FreeU или Google, напрямую из базы данных.';
  ...
  @override
  String get omiTraining => 'Обучение FreeU';
  ...
  String get getOmiUnlimitedFree =>
      'Получите FreeU Unlimited бесплатно, предоставив свои данные для обучения моделей ИИ.';
  ...
  @override
  String get learnMoreAtOmiTraining => 'Узнайте больше на FreeU.me/training';
  ...
  @override
  String get yourOmiUnleashed => 'Ваш FreeU, раскрытый. Перейдите на безлимит для бесконечных возможностей.';
  ...
  @override
  String get askOmiAnything => 'Спросите FreeU о чём угодно о своей жизни';

  @override
  String get unlockOmiInfiniteMemory => 'Разблокируйте бесконечную память FreeU';
  ...
  String get privacyIntroText =>
      'В FreeU мы очень серьезно относимся к вашей конфиденциальности. Мы хотим быть прозрачными в отношении собираемых данных и их использования. Вот что вам нужно знать:';
  ...
  String get commitmentText =>
      'Мы обязуемся использовать собранные данные только для улучшения FreeU для вас. Ваша конфиденциальность и доверие имеют для нас первостепенное значение.';

  @override
  String get thankYouText =>
      'Спасибо, что вы ценный пользователь FreeU. Если у вас есть вопросы или проблемы, свяжитесь с нами по адресу team@basedhardware.com.';
  ...
  String get howPeopleWorks =>
      'После создания человека вы можете перейти к расшифровке разговора и назначить ему соответствующие сегменты, тогда FreeU сможет распознавать и его речь!';
  ...
  @override
  String get installOmiOnAppleWatch => 'Установите FreeU на\nApple Watch';

  @override
  String get installOmiOnAppleWatchDescription =>
      'Чтобы использовать Apple Watch с FreeU, сначала необходимо установить приложение FreeU на часы.';

  @override
  String get openOmiOnAppleWatch => 'Откройте FreeU на\nApple Watch';

  @override
  String get openOmiOnAppleWatchDescription =>
      'Приложение FreeU установлено на Apple Watch. Откройте его и нажмите Старт.';
  ...
  String get unableToOpenWatchApp =>
      'Не удалось открыть приложение Apple Watch. Откройте приложение Watch вручную на Apple Watch и установите FreeU из раздела \"Доступные приложения\".';
  ...
  String get appleWatchNotReachable =>
      'Apple Watch все еще недоступны. Убедитесь, что приложение FreeU открыто на часах.';
  ...
  @override
  String get updateOmiFirmware => 'Обновить прошивку FreeU';
  ...
  @override
  String get addVocabularyDescription => 'Добавьте слова, которые FreeU должен распознавать при транскрипции.';
  ...
  @override
  String get wrappedOmiLifeRecap => 'Обзор жизни FreeU';

  @override
  String get wrappedSwipeUpToBegin => 'Свайпни вверх, чтобы начать';

  @override
  String get wrappedShareText => 'Мой 2025, сохранённый FreeU ✨ FreeU.me/wrapped';
  ...
  @override
  String get wrappedRememberedByOmi => 'сохранённый FreeU';
  ...
  @override
  String get controlNotificationFrequency => 'Управляйте частотой отправки проактивных уведомлений от FreeU.';
  ...
  String get notificationFrequencyDescription =>
      'Управляйте тем, как часто FreeU отправляет вам проактивные уведомления и напоминания.';
  ...
  @override
  String get audioFromOmiWillAppearHere => 'Аудио с вашего устройства FreeU появится здесь';
  ...
  @override
  String get considerOmiCloud => 'Рассмотрите использование FreeU Cloud для лучшей производительности.';
  ...
  String get omiTranscriptionOptimized =>
      'Встроенная живая транскрипция FreeU оптимизирована для разговоров в реальном времени с автоматическим определением говорящего и диаризацией.';
  ...
  @override
  String get setupQuestionsIntro => 'Помогите нам улучшить FreeU, ответив на несколько вопросов. 🫶 💜';

  @override
  String get setupQuestionProfession => '1. Чем вы занимаетесь?';

  @override
  String get setupQuestionUsage => '2. Где вы планируете использовать FreeU?';
  ...
  @override
  String get getOmi => 'Получить FreeU';

  @override
  String get iHaveOmiDevice => 'У меня есть устройство FreeU';
  ...
  String get fastTransferDescription =>
      'Быстрая передача использует WiFi для ~5x более быстрых скоростей. Ваш телефон временно подключится к WiFi-сети устройства FreeU во время передачи.';

  @override
  String get internetAccessPausedDuringTransfer => 'Доступ в интернет приостановлен во время передачи';

  @override
  String get chooseTransferMethodDescription => 'Выберите, как записи передаются с устройства FreeU на телефон.';
  ...
  String get fastTransferMethodDescription =>
      'Создаёт прямое WiFi-подключение к устройству FreeU. Телефон временно отключается от обычного WiFi во время передачи.';
  ...
  @override
  String get deviceDisconnectedNotificationTitle => 'Ваше устройство FreeU отключено';

  @override
  String get deviceDisconnectedNotificationBody =>
      'Пожалуйста, подключитесь снова, чтобы продолжить использование FreeU.';
  ...
  String firmwareUpdateAvailableDescription(String version) {
    return 'Для вашего устройства FreeU доступно новое обновление прошивки ($version). Хотите обновить сейчас?';
  }
  ...
  @override
  String get omiSays => 'FreeU говорит';
  ...
  @override
  String get personaConnectKnowledgeSource => 'Подключите хотя бы один источник данных (FreeU или Twitter)';
  ...
  @override
  String get xHandleDescription => 'Мы предварительно обучим вашего клона FreeU\nна основе активности вашего аккаунта';
  ...
  @override
  String get connectOmiDevice => 'Подключить устройство FreeU';
  ...
  @override
  String get actionItemReminderTitle => 'Напоминание FreeU';
  ...
  @override
  String get onboardingWelcomeToOmi => 'Добро пожаловать в FreeU';
  ...
  @override
  String get pairingTitleOmi => 'Включите FreeU';

  @override
  String get pairingDescOmi => 'Нажмите и удерживайте устройство, пока оно не завибрирует, чтобы включить его.';

  @override
  String get pairingTitleOmiDevkit => 'Переведите FreeU DevKit в режим сопряжения';
  ...
  @override
  String get pairingTitleOmiGlass => 'Включите FreeU Glass';
  ...
  String get pairingDescAppleWatch =>
      'Установите и откройте приложение FreeU на Apple Watch, затем нажмите Подключить в приложении.';
