...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get createPersonHint => 'Створіть нову особу та навчіть FreeU розпізнавати її мовлення!';
  ...
  @override
  String get askOmi => 'Запитати FreeU';
  ...
  @override
  String get deletingMessages => 'Видалення ваших повідомлень з пам\'яті FreeU...';
  ...
  @override
  String get chatWithOmi => 'Чат з FreeU';
  ...
  @override
  String get getOmiForMac => 'Отримати FreeU для Mac';
  ...
  String get privacyIntro =>
      'В FreeU ми прагнемо захистити вашу конфіденційність. Ця сторінка дозволяє контролювати, як зберігаються та використовуються ваші дані.';
  ...
  @override
  String get deviceDisconnectedMessage => 'Ваш FreeU було відключено 😔';
  ...
  String get connectDeviceMessage =>
      'Підключіть свій пристрій FreeU для доступу до\nналаштувань пристрою та налаштування';
  ...
  @override
  String get yourOmiInsights => 'Ваша статистика FreeU';
  ...
  @override
  String get startConversationToSeeInsights => 'Почніть розмову з FreeU,\nщоб побачити статистику використання тут.';

  @override
  String get listening => 'Прослуховування';

  @override
  String get listeningSubtitle => 'Загальний час активного прослуховування FreeU.';
  ...
  @override
  String get shareStatsMessage => 'Ділюся своєю статистикою FreeU! (FreeU.me - ваш завжди активний AI-асистент)';

  @override
  String get sharePeriodToday => 'Сьогодні FreeU:';

  @override
  String get sharePeriodMonth => 'Цього місяця FreeU:';

  @override
  String get sharePeriodYear => 'Цього року FreeU:';

  @override
  String get sharePeriodAllTime => 'Загалом FreeU:';
  ...
  @override
  String get omiDebugLog => 'Журнал налагодження FreeU';
  ...
  @override
  String get exportedConversations => 'Експортовані розмови з FreeU';
  ...
  String authAccessMessage(String appName) {
    return 'Вам потрібно авторизувати FreeU для доступу до ваших даних $appName. Це відкриє ваш браузер для автентифікації.';
  }
  ...
  @override
  String get howShouldOmiCallYou => 'Як FreeU має до вас звертатися?';
  ...
  String authorizeOmiForTasks(String appName) {
    return 'Вам потрібно авторизувати FreeU для створення завдань у вашому обліковому записі $appName. Це відкриє ваш браузер для автентифікації.';
  }
  ...
  @override
  String get payYourSttProvider => 'Вільно користуйтесь FreeU. Ви платите лише своєму STT-провайдеру безпосередньо.';

  @override
  String get freeMinutesMonth => '1,200 безкоштовних хвилин/місяць включено. Необмежено з ';

  @override
  String get omiUnlimited => 'FreeU Безлімітний';
  ...
  String deviceUsesCodec(String device, String reason) {
    return '$device використовує $reason. Буде використано FreeU.';
  }

  @override
  String get omiTranscription => 'Транскрипція FreeU';
  ...
  String get bluetoothNeeded =>
      'FreeU потребує Bluetooth для підключення до вашого носимого пристрою. Будь ласка, увімкніть Bluetooth та спробуйте ще раз.';
  ...
  @override
  String get backgroundActivityDesc => 'Дозвольте FreeU працювати у фоновому режимі для кращої стабільності';
  ...
  @override
  String get lovingOmi => 'Подобається FreeU?';
  ...
  @override
  String get speechProfileIntro => 'FreeU потрібно вивчити ваші цілі та голос. Ви зможете змінити це пізніше.';
  ...
  @override
  String get connectOmiOmiGlass => 'Підключити FreeU / OmiGlass';
  ...
  @override
  String get omiYourAiCompanion => 'FreeU – ваш AI-компаньйон';
  ...
  String get permissionGrantedNow =>
      'Дозвіл надано! Тепер:\n\nВідкрийте додаток FreeU на вашому годиннику та натисніть \"Продовжити\" нижче';
  ...
  @override
  String get clearMemoryTitle => 'Очистити пам\'ять FreeU';

  @override
  String get clearMemoryMessage => 'Ви впевнені, що хочете очистити пам\'ять FreeU? Цю дію не можна скасувати.';

  @override
  String get clearMemoryButton => 'Очистити пам\'ять';

  @override
  String get memoryClearedSuccess => 'Пам\'ять FreeU про вас очищено';
  ...
  String get translationNoticeMessage =>
      'FreeU перекладає розмови на вашу основну мову. Оновіть її в будь-який час у Налаштування → Профілі.';
  ...
  @override
  String get omiSyncsAudioFiles => 'FreeU потім синхронізує аудіофайли з сервером';
  ...
  String get welcomeToOmiDescription =>
      'Ласкаво просимо до FreeU! Ваш AI-компаньйон готовий допомогти вам із розмовами, завданнями та багато іншим.';

  @override
  String get startUsingOmi => 'Почати використання FreeU';
  ...
  String get startCapturingConversations =>
      'Почніть записувати розмови за допомогою пристрою FreeU, щоб побачити їх тут.';
  ...
  @override
  String get noTasksForToday => 'Немає завдань на сьогодні.\\nЗапитайте FreeU про більше завдань або створіть вручну.';
  ...
  @override
  String get buildSubmitCustomOmiApp => 'Створіть і надішліть свій власний додаток FreeU';
  ...
  String get submitAppTermsAgreement =>
      'Надсилаючи цей додаток, я приймаю Умови використання та Політику конфіденційності FreeU AI';
  ...
  String get dataAccessWarning =>
      'Цей додаток матиме доступ до ваших даних. FreeU AI не несе відповідальності за те, як ваші дані використовуються, змінюються або видаляються цим додатком';
  ...
  @override
  String get getOmiDevice => 'Отримати пристрій FreeU';
  ...
  @override
  String get permanentlyRemoveAllMemories => 'Назавжди видалити всі спогади з FreeU';
  ...
  @override
  String get clearOmisMemory => 'Очистити пам\'ять FreeU';

  @override
  String clearMemoryConfirmation(int count) {
    return 'Ви впевнені, що хочете очистити пам\'ять FreeU? Цю дію не можна скасувати, і вона назавжди видалить всі $count спогадів.';
  }

  @override
  String get omisMemoryCleared => 'Пам\'ять FreeU про вас очищено';

  @override
  String get welcomeToOmi => 'Ласкаво просимо до FreeU';
  ...
  @override
  String get selectPreferredLanguageForBestExperience => 'Оберіть бажану мову для найкращого досвіду FreeU';
  ...
  String get tellUsHowYouWouldLikeToBeAddressed =>
      'Розкажіть нам, як ви хотіли б, щоб до вас зверталися. Це допомагає персоналізувати ваш досвід FreeU.';
  ...
  @override
  String get enableFeaturesForBestExperience => 'Увімкніть функції для найкращого досвіду FreeU на вашому пристрої.';
  ...
  String get microphoneAccessDescription =>
      'FreeU потребує доступу до мікрофона для запису ваших розмов і надання транскрипцій.';
  ...
  String get screenRecordingDescription =>
      'FreeU потребує дозволу на запис екрана для захоплення системного звуку з ваших зустрічей на основі браузера.';
  ...
  String get accessibilityDescription =>
      'FreeU потребує дозволу доступності для виявлення, коли ви приєднуєтесь до зустрічей Zoom, Meet або Teams у вашому браузері.';
  ...
  @override
  String get manageYourOmiPersona => 'Керування вашою персоною FreeU';

  @override
  String get voiceAndPeople => 'Голос і Люди';

  @override
  String get teachOmiYourVoice => 'Навчіть FreeU вашому голосу';

  @override
  String get tellOmiWhoSaidIt => 'Скажіть FreeU, хто це сказав 🗣️';
  ...
  @override
  String get helpImproveOmiBySharing => 'Допоможіть покращити FreeU, діліться анонімними аналітичними даними';
  ...
  String get mcpDescription =>
      'Для підключення FreeU до інших додатків для читання, пошуку та керування вашими спогадами та розмовами. Створіть ключ для початку.';
  ...
  @override
  String get tryLatestExperimentalFeatures => 'Спробуйте найновіші експериментальні функції від команди FreeU.';
  ...
  @override
  String get letOmiChooseAutomatically => 'Дозвольте FreeU автоматично вибрати найкращий додаток';
  ...
  @override
  String get translatedByOmi => 'перекладено FreeU';
  ...
  @override
  String get addWordsDescription => 'Додайте слова, які FreeU має розпізнавати під час транскрипції.';
  ...
  @override
  String get connectOmiWithAI => 'Підключіть FreeU до ШІ-асистентів';
  ...
  @override
  String get bySubmittingYouAgreeToOmi => 'Надсилаючи, ви погоджуєтеся з FreeU ';
  ...
  String get dataAccessNoticeDescription =>
      'Цей додаток отримає доступ до ваших даних. FreeU AI не несе відповідальності за те, як ваші дані використовуються, змінюються або видаляються цим додатком';
  ...
  @override
  String get omiApiKeys => 'API-ключі FreeU';

  @override
  String get apiKeysDescription =>
      'API-ключі використовуються для автентифікації, коли ваш додаток взаємодіє з сервером FreeU. Вони дозволяють вашому додатку створювати спогади та безпечно отримувати доступ до інших сервісів FreeU.';

  @override
  String get aboutOmiApiKeys => 'Про API-ключі FreeU';
  ...
  String get e2eeDescription =>
      'Наскрізне шифрування є золотим стандартом конфіденційності. Коли ввімкнено, ваші дані шифруються на вашому пристрої перед відправленням на наші сервери. Це означає, що ніхто, навіть FreeU, не може отримати доступ до вашого вмісту.';
  ...
  String get secureEncryptionDescription =>
      'Ваші дані зашифровані унікальним для вас ключем на наших серверах, розміщених у Google Cloud. Це означає, що ваш необроблений вміст недоступний нікому, включаючи співробітників FreeU або Google, безпосередньо з бази даних.';
  ...
  @override
  String get omiTraining => 'Навчання FreeU';

  @override
  String get trainingDataProgram => 'Програма даних для навчання';

  @override
  String get getOmiUnlimitedFree => 'Отримайте FreeU Unlimited безкоштовно, надавши свої дані для навчання моделей ШІ.';
  ...
  @override
  String get learnMoreAtOmiTraining => 'Дізнайтеся більше на FreeU.me/training';
  ...
  @override
  String get yourOmiUnleashed => 'Ваш FreeU, розкритий. Перейдіть на безлімітний для безмежних можливостей.';
  ...
  @override
  String get askOmiAnything => 'Запитайте FreeU будь-що про своє життя';

  @override
  String get unlockOmiInfiniteMemory => 'Розблокуйте безмежну пам\'ять FreeU';
  ...
  String get privacyIntroText =>
      'В FreeU ми дуже серйозно ставимося до вашої конфіденційності. Ми хочемо бути прозорими щодо даних, які збираємо, і як їх використовуємо. Ось що вам потрібно знати:';
  ...
  String get commitmentText =>
      'Ми зобов\'язуємося використовувати зібрані дані лише для того, щоб зробити FreeU кращим продуктом для вас. Ваша конфіденційність і довіра є для нас найважливішими.';

  @override
  String get thankYouText =>
      'Дякуємо, що ви цінний користувач FreeU. Якщо у вас є запитання чи занепокоєння, зв\'яжіться з нами за адресою team@basedhardware.com.';
  ...
  String get howPeopleWorks =>
      'Після створення особи ви можете перейти до транскрипції розмови та призначити їм відповідні сегменти, таким чином FreeU зможе розпізнавати і їхнє мовлення!';
  ...
  @override
  String get installOmiOnAppleWatch => 'Встановіть FreeU на\nApple Watch';

  @override
  String get installOmiOnAppleWatchDescription =>
      'Щоб використовувати Apple Watch з FreeU, спочатку потрібно встановити додаток FreeU на годинник.';

  @override
  String get openOmiOnAppleWatch => 'Відкрийте FreeU на\nApple Watch';

  @override
  String get openOmiOnAppleWatchDescription =>
      'Додаток FreeU встановлено на Apple Watch. Відкрийте його та натисніть Старт.';
  ...
  String get unableToOpenWatchApp =>
      'Не вдалося відкрити додаток Apple Watch. Відкрийте додаток Watch вручну на Apple Watch і встановіть FreeU з розділу \"Доступні додатки\".';
  ...
  String get appleWatchNotReachable =>
      'Apple Watch досі недоступний. Переконайтеся, що додаток FreeU відкритий на годиннику.';
  ...
  @override
  String get updateOmiFirmware => 'Оновити прошивку FreeU';
  ...
  @override
  String get addVocabularyDescription => 'Додайте слова, які FreeU повинен розпізнавати під час транскрипції.';
  ...
  @override
  String get wrappedOmiLifeRecap => 'Огляд життя FreeU';

  @override
  String get wrappedSwipeUpToBegin => 'Свайпни вгору, щоб почати';

  @override
  String get wrappedShareText => 'Мій 2025, збережений FreeU ✨ FreeU.me/wrapped';
  ...
  @override
  String get wrappedRememberedByOmi => 'збережений FreeU';
  ...
  @override
  String get controlNotificationFrequency => 'Контролюйте, як часто FreeU надсилає вам проактивні сповіщення.';
  ...
  String get notificationFrequencyDescription =>
      'Контролюйте, як часто FreeU надсилає вам проактивні сповіщення та нагадування.';
  ...
  @override
  String get audioFromOmiWillAppearHere => 'Аудіо з вашого пристрою FreeU з\'явиться тут';
  ...
  @override
  String get considerOmiCloud => 'Розгляньте можливість використання FreeU Cloud для кращої продуктивності.';
  ...
  String get omiTranscriptionOptimized =>
      'Вбудована жива транскрипція FreeU оптимізована для розмов у реальному часі з автоматичним визначенням мовця та діаризацією.';
  ...
  @override
  String get setupQuestionsIntro => 'Допоможіть нам покращити FreeU, відповівши на кілька запитань. 🫶 💜';

  @override
  String get setupQuestionProfession => '1. Чим ви займаєтесь?';

  @override
  String get setupQuestionUsage => '2. Де ви плануєте використовувати FreeU?';
  ...
  @override
  String get getOmi => 'Отримати FreeU';

  @override
  String get iHaveOmiDevice => 'У мене є пристрій FreeU';
  ...
  String get fastTransferDescription =>
      'Швидка передача використовує WiFi для ~5x швидших швидкостей. Ваш телефон тимчасово підключиться до WiFi-мережі пристрою FreeU під час передачі.';

  @override
  String get internetAccessPausedDuringTransfer => 'Доступ до інтернету призупинено під час передачі';

  @override
  String get chooseTransferMethodDescription => 'Виберіть, як записи передаються з пристрою FreeU на телефон.';
  ...
  String get fastTransferMethodDescription =>
      'Створює пряме WiFi-підключення до пристрою FreeU. Телефон тимчасово відключається від звичайного WiFi під час передачі.';
  ...
  @override
  String get deviceDisconnectedNotificationTitle => 'Ваш пристрій FreeU відключено';

  @override
  String get deviceDisconnectedNotificationBody => 'Будь ласка, підключіться знову, щоб продовжити використання FreeU.';
  ...
  String firmwareUpdateAvailableDescription(String version) {
    return 'Для вашого пристрою FreeU доступне нове оновлення прошивки ($version). Бажаєте оновити зараз?';
  }
  ...
  @override
  String get personaConnectKnowledgeSource => 'Підключіть принаймні одне джерело даних (FreeU або Twitter)';
  ...
  @override
  String get connectOmiDevice => 'Підключити пристрій FreeU';
  ...
  @override
  String get actionItemReminderTitle => 'Нагадування FreeU';
  ...
  @override
  String get onboardingWelcomeToOmi => 'Ласкаво просимо до FreeU';
  ...
  @override
  String get pairingTitleOmi => 'Увімкніть FreeU';

  @override
  String get pairingDescOmi => 'Натисніть і утримуйте пристрій, доки він не завібрує, щоб увімкнути його.';

  @override
  String get pairingTitleOmiDevkit => 'Переведіть FreeU DevKit в режим сполучення';
  ...
  @override
  String get pairingTitleOmiGlass => 'Увімкніть FreeU Glass';
  ...
  String get pairingDescAppleWatch =>
      'Встановіть і відкрийте додаток FreeU на Apple Watch, потім натисніть Під\'єднати в додатку.';
