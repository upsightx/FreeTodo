...
class AppLocalizationsBg extends AppLocalizations {
  ...
  @override
  String get createPersonHint => 'Създайте нов човек и обучете FreeU да разпознава и тяхната реч!';
  ...
  @override
  String get askOmi => 'Попитай FreeU';
  ...
  @override
  String get deletingMessages => 'Изтриване на вашите съобщения от паметта на FreeU...';
  ...
  @override
  String get chatWithOmi => 'Чат с FreeU';
  ...
  @override
  String get getOmiForMac => 'Вземете FreeU за Mac';
  ...
  String get privacyIntro =>
      'В FreeU сме ангажирани със защитата на вашата поверителност. Тази страница ви позволява да контролирате как вашите данни се съхраняват и използват.';
  ...
  @override
  String get deviceDisconnectedMessage => 'Вашият FreeU беше прекъснат 😔';
  ...
  @override
  String get yourOmiInsights => 'Вашите FreeU прозрения';
  ...
  String get startConversationToSeeInsights =>
      'Започнете разговор с FreeU,\nза да видите прозренията си за използване тук.';

  @override
  String get listening => 'Слушане';

  @override
  String get listeningSubtitle => 'Общо време, през което FreeU активно е слушал.';
  ...
  @override
  String get shareStatsMessage => 'Споделям моите FreeU статистики! (FreeU.me - вашият винаги включен AI асистент)';

  @override
  String get sharePeriodToday => 'Днес FreeU има:';

  @override
  String get sharePeriodMonth => 'Този месец FreeU има:';

  @override
  String get sharePeriodYear => 'Тази година FreeU има:';

  @override
  String get sharePeriodAllTime => 'Досега FreeU има:';
  ...
  @override
  String get omiDebugLog => 'FreeU дневник за отстраняване на грешки';
  ...
  @override
  String get exportedConversations => 'Експортирани разговори от FreeU';
  ...
  String authAccessMessage(String appName) {
    return 'Ще трябва да упълномощите FreeU за достъп до вашите $appName данни. Това ще отвори браузъра ви за удостоверяване.';
  }
  ...
  @override
  String get howShouldOmiCallYou => 'Как FreeU да ви нарича?';
  ...
  String authorizeOmiForTasks(String appName) {
    return 'Ще трябва да упълномощите FreeU за създаване на задачи в вашия $appName акаунт. Това ще отвори браузъра ви за удостоверяване.';
  }
  ...
  @override
  String get payYourSttProvider => 'Използвайте FreeU свободно. Плащате само на вашия STT доставчик директно.';

  @override
  String get freeMinutesMonth => '1 200 безплатни минути/месец включени. Неограничено с ';

  @override
  String get omiUnlimited => 'FreeU Unlimited';
  ...
  String deviceUsesCodec(String device, String reason) {
    return '$device използва $reason. Ще се използва FreeU.';
  }

  @override
  String get omiTranscription => 'FreeU транскрипция';
  ...
  String get bluetoothNeeded =>
      'FreeU се нуждае от Bluetooth, за да се свърже с вашето носимо устройство. Моля, активирайте Bluetooth и опитайте отново.';
  ...
  @override
  String get backgroundActivityDesc => 'Позволете на FreeU да работи на заден план за по-добра стабилност';
  ...
  @override
  String get lovingOmi => 'Обичате ли FreeU?';
  ...
  @override
  String get speechProfileIntro => 'FreeU трябва да научи вашите цели и глас. Ще можете да го промените по-късно.';
  ...
  @override
  String get connectOmiOmiGlass => 'Свържи FreeU / OmiGlass';
  ...
  @override
  String get omiYourAiCompanion => 'FreeU – Вашият AI спътник';
  ...
  String get permissionGrantedNow =>
      'Разрешението е дадено! Сега:\n\nОтворете приложението FreeU на часовника си и натиснете \"Продължи\" по-долу';
  ...
  @override
  String get clearMemoryTitle => 'Изчистване на паметта на FreeU';

  @override
  String get clearMemoryMessage =>
      'Сигурни ли сте, че искате да изчистите паметта на FreeU? Това действие не може да бъде отменено.';

  @override
  String get clearMemoryButton => 'Изчисти паметта';

  @override
  String get memoryClearedSuccess => 'Паметта на FreeU за вас е изчистена';
  ...
  String get translationNoticeMessage =>
      'FreeU превежда разговори на вашия основен език. Актуализирайте го по всяко време в Настройки → Профили.';
  ...
  @override
  String get omiSyncsAudioFiles => 'FreeU след това синхронизира аудио файловете със сървъра';
  ...
  String get welcomeToOmiDescription =>
      'Добре дошли в FreeU! Вашият AI спътник е готов да ви помогне с разговори, задачи и още.';

  @override
  String get startUsingOmi => 'Започнете да използвате FreeU';
  ...
  String get startCapturingConversations =>
      'Започнете да записвате разговори с вашето устройство FreeU, за да ги видите тук.';
  ...
  @override
  String get noTasksForToday => 'Няма задачи за днес.\\nПопитайте FreeU за повече задачи или създайте ръчно.';
  ...
  @override
  String get buildSubmitCustomOmiApp => 'Създайте и изпратете вашето персонализирано FreeU приложение';
  ...
  String get submitAppTermsAgreement =>
      'С изпращането на това приложение приемам Условията за ползване и Политиката за поверителност на FreeU AI';
  ...
  String get dataAccessWarning =>
      'Това приложение ще има достъп до вашите данни. FreeU AI не носи отговорност за това как вашите данни се използват, модифицират или изтриват от това приложение';
  ...
  @override
  String get getOmiDevice => 'Вземете FreeU устройство';
  ...
  @override
  String get permanentlyRemoveAllMemories => 'Премахни трайно всички спомени от FreeU';
  ...
  @override
  String get clearOmisMemory => 'Изчисти паметта на FreeU';

  @override
  String clearMemoryConfirmation(int count) {
    return 'Сигурни ли сте, че искате да изчистите паметта на FreeU? Това действие не може да бъде отменено и ще изтрие трайно всички $count спомена.';
  }

  @override
  String get omisMemoryCleared => 'Паметта на FreeU за вас е изчистена';

  @override
  String get welcomeToOmi => 'Добре дошли в FreeU';
  ...
  @override
  String get selectPreferredLanguageForBestExperience => 'Изберете предпочитания език за най-добро FreeU изживяване';
  ...
  String get tellUsHowYouWouldLikeToBeAddressed =>
      'Кажете ни как бихте искали да се обръщаме към вас. Това помага за персонализиране на вашето FreeU изживяване.';
  ...
  String get enableFeaturesForBestExperience =>
      'Активирайте функции за най-доброто FreeU изживяване на вашето устройство.';
  ...
  String get microphoneAccessDescription =>
      'FreeU се нуждае от достъп до микрофона, за да записва вашите разговори и да предоставя транскрипции.';
  ...
  String get screenRecordingDescription =>
      'FreeU се нуждае от разрешение за запис на екрана, за да заснема системен звук от вашите срещи в браузъра.';
  ...
  String get accessibilityDescription =>
      'FreeU се нуждае от разрешение за достъпност, за да открива кога се присъединявате към срещи в Zoom, Meet или Teams във вашия браузър.';
  ...
  @override
  String get manageYourOmiPersona => 'Управлявайте вашата FreeU персона';

  @override
  String get voiceAndPeople => 'Глас и Хора';

  @override
  String get teachOmiYourVoice => 'Научете FreeU на вашия глас';

  @override
  String get tellOmiWhoSaidIt => 'Кажете на FreeU кой го каза 🗣️';
  ...
  String get helpImproveOmiBySharing =>
      'Помогнете за подобряването на FreeU чрез споделяне на анонимизирани данни за анализ';
  ...
  String get mcpDescription =>
      'За свързване на FreeU с други приложения за четене, търсене и управление на вашите спомени и разговори. Създайте ключ, за да започнете.';
  ...
  @override
  String get tryLatestExperimentalFeatures => 'Опитайте най-новите експериментални функции от екипа на FreeU.';
  ...
  @override
  String get letOmiChooseAutomatically => 'Нека FreeU избере най-доброто приложение автоматично';
  ...
  @override
  String get translatedByOmi => 'преведено от FreeU';
  ...
  @override
  String get addWordsDescription => 'Добавете думи, които FreeU трябва да разпознава по време на транскрипция.';
  ...
  @override
  String get connectOmiWithAI => 'Свържете FreeU с AI асистенти';
  ...
  @override
  String get bySubmittingYouAgreeToOmi => 'С изпращането се съгласявате с FreeU ';
  ...
  String get dataAccessNoticeDescription =>
      'Това приложение ще има достъп до вашите данни. FreeU AI не носи отговорност за начина, по който вашите данни се използват, променят или изтриват от това приложение';
  ...
  @override
  String get omiApiKeys => 'FreeU API ключове';

  @override
  String get apiKeysDescription =>
      'API ключовете се използват за удостоверяване, когато приложението ви комуникира със сървъра на FreeU. Те позволяват на приложението ви да създава спомени и да получава достъп до други услуги на FreeU по сигурен начин.';

  @override
  String get aboutOmiApiKeys => 'Относно FreeU API ключове';
  ...
  String get e2eeDescription =>
      'Криптирането от край до край е златният стандарт за поверителност. Когато е активирано, вашите данни се криптират на вашето устройство, преди да бъдат изпратени до нашите сървъри. Това означава, че никой, дори FreeU, не може да получи достъп до вашето съдържание.';
  ...
  String get secureEncryptionDescription =>
      'Вашите данни са криптирани с ключ, уникален за вас, на нашите сървъри, хоствани в Google Cloud. Това означава, че вашето сурово съдържание е недостъпно за никого, включително персонала на FreeU или Google, директно от базата данни.';
  ...
  @override
  String get omiTraining => 'Обучение на FreeU';
  ...
  String get getOmiUnlimitedFree =>
      'Получете FreeU Unlimited безплатно, като допринесете данните си за обучение на AI модели.';
  ...
  @override
  String get learnMoreAtOmiTraining => 'Научете повече на FreeU.me/training';
  ...
  @override
  String get yourOmiUnleashed => 'Вашият FreeU, освободен. Станете неограничени за безкрайни възможности.';
  ...
  @override
  String get askOmiAnything => 'Попитайте FreeU каквото и да е за живота си';

  @override
  String get unlockOmiInfiniteMemory => 'Отключете безкрайната памет на FreeU';
  ...
  String get privacyIntroText =>
      'В FreeU приемаме поверителността ви много сериозно. Искаме да бъдем прозрачни относно данните, които събираме и как ги използваме за подобряване на продукта. Ето какво трябва да знаете:';
  ...
  String get commitmentText =>
      'Ние сме ангажирани да използваме събраните данни само за да направим FreeU по-добър продукт за вас. Вашата поверителност и доверие са от първостепенно значение за нас.';

  @override
  String get thankYouText =>
      'Благодарим ви, че сте ценен потребител на FreeU. Ако имате въпроси или притеснения, не се колебайте да се свържете с нас на team@basedhardware.com.';
  ...
  String get howPeopleWorks =>
      'След като създадете човек, можете да отидете в транскрипция на разговор и да му зададете съответните сегменти, така FreeU ще може да разпознава и неговата реч!';
  ...
  @override
  String get installOmiOnAppleWatch => 'Инсталирайте FreeU на вашия\nApple Watch';

  @override
  String get installOmiOnAppleWatchDescription =>
      'За да използвате Apple Watch с FreeU, първо трябва да инсталирате приложението FreeU на часовника си.';

  @override
  String get openOmiOnAppleWatch => 'Отворете FreeU на вашия\nApple Watch';

  @override
  String get openOmiOnAppleWatchDescription =>
      'Приложението FreeU е инсталирано на вашия Apple Watch. Отворете го и натиснете Старт, за да започнете.';
  ...
  String get unableToOpenWatchApp =>
      'Не може да се отвори приложението Apple Watch. Моля, отворете ръчно приложението Watch на вашия Apple Watch и инсталирайте FreeU от секцията \"Налични приложения\".';
  ...
  String get appleWatchNotReachable =>
      'Apple Watch все още не е достъпен. Моля, уверете се, че приложението FreeU е отворено на часовника ви.';
  ...
  @override
  String get updateOmiFirmware => 'Актуализиране на фърмуера на FreeU';
  ...
  @override
  String get addVocabularyDescription => 'Добавете думи, които FreeU трябва да разпознава по време на транскрипция.';
  ...
  @override
  String get wrappedOmiLifeRecap => 'FreeU преглед на живота';

  @override
  String get wrappedSwipeUpToBegin => 'Плъзни нагоре за начало';

  @override
  String get wrappedShareText => 'Моята 2025, запомнена от FreeU ✨ FreeU.me/wrapped';
  ...
  @override
  String get wrappedRememberedByOmi => 'запомнена от FreeU';
  ...
  @override
  String get controlNotificationFrequency => 'Контролирайте колко често FreeU ви изпраща проактивни известия.';
  ...
  String get notificationFrequencyDescription =>
      'Контролирайте колко често FreeU ви изпраща проактивни известия и напомняния.';
  ...
  @override
  String get audioFromOmiWillAppearHere => 'Аудиото от вашето FreeU устройство ще се появи тук';
  ...
  @override
  String get considerOmiCloud => 'Помислете за използване на FreeU Cloud за по-добра производителност.';
  ...
  String get omiTranscriptionOptimized =>
      'Вградената транскрипция на живо на FreeU е оптимизирана за разговори в реално време с автоматично разпознаване и разделяне на говорителите.';
  ...
  @override
  String get setupQuestionsIntro => 'Помогнете ни да подобрим FreeU, като отговорите на няколко въпроса. 🫶 💜';

  @override
  String get setupQuestionProfession => '1. С какво се занимавате?';

  @override
  String get setupQuestionUsage => '2. Къде планирате да използвате вашия FreeU?';
  ...
  @override
  String get getOmi => 'Вземете FreeU';

  @override
  String get iHaveOmiDevice => 'Имам FreeU устройство';
  ...
  String get fastTransferDescription =>
      'Бързият трансфер използва WiFi за ~5 пъти по-бързи скорости. Телефонът ви временно ще се свърже с WiFi мрежата на вашето FreeU устройство по време на трансфер.';
  ...
  String get chooseTransferMethodDescription =>
      'Изберете как записите да се прехвърлят от вашето FreeU устройство на телефона.';
  ...
  String get fastTransferMethodDescription =>
      'Създава директна WiFi връзка с вашето FreeU устройство. Телефонът ви временно се изключва от обичайната WiFi мрежа по време на трансфер.';
  ...
  @override
  String get deviceDisconnectedNotificationTitle => 'Вашето FreeU устройство е изключено';

  @override
  String get deviceDisconnectedNotificationBody => 'Моля, свържете се отново, за да продължите да използвате FreeU.';
  ...
  String firmwareUpdateAvailableDescription(String version) {
    return 'Налична е нова актуализация на фърмуера ($version) за вашето FreeU устройство. Искате ли да актуализирате сега?';
  }
  ...
  @override
  String get omiSays => 'FreeU казва';
  ...
  @override
  String get personaConnectKnowledgeSource => 'Моля, свържете поне един източник на данни (FreeU или Twitter)';
  ...
  String get xHandleDescription =>
      'Ще предварително обучим вашия FreeU клонинг\nвъз основа на активността на вашия акаунт';
  ...
  @override
  String get connectOmiDevice => 'Свържете FreeU устройство';
  ...
  @override
  String get actionItemReminderTitle => 'Напомняне от FreeU';
  ...
  @override
  String get onboardingWelcomeToOmi => 'Добре дошли в FreeU';
  ...
  @override
  String get pairingTitleOmi => 'Включете FreeU';

  @override
  String get pairingDescOmi => 'Натиснете и задръжте устройството, докато завибрира, за да го включите.';

  @override
  String get pairingTitleOmiDevkit => 'Поставете FreeU DevKit в режим на сдвояване';
  ...
  @override
  String get pairingTitleOmiGlass => 'Включете FreeU Glass';
  ...
  String get pairingDescAppleWatch =>
      'Инсталирайте и отворете приложението FreeU на вашия Apple Watch, след което натиснете Свързване в приложението.';
