...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get askOmi => 'Ρώτησε το FreeU';
  ...
  @override
  String get deletingMessages => 'Διαγραφή των μηνυμάτων σας από τη μνήμη του FreeU...';
  ...
  @override
  String get chatWithOmi => 'Συνομιλία με το FreeU';
  ...
  @override
  String get aboutOmi => 'Σχετικά με το FreeU';
  ...
  @override
  String get getOmiForMac => 'Αποκτήστε το FreeU για Mac';
  ...
  String get privacyIntro =>
      'Στο FreeU, δεσμευόμαστε να προστατεύουμε το απόρρητό σας. Αυτή η σελίδα σας επιτρέπει να ελέγχετε πώς αποθηκεύονται και χρησιμοποιούνται τα δεδομένα σας.';
  ...
  @override
  String get deviceDisconnectedMessage => 'Το FreeU σας έχει αποσυνδεθεί 😔';
  ...
  String get connectDeviceMessage =>
      'Συνδέστε τη συσκευή FreeU για να αποκτήσετε πρόσβαση\nστις ρυθμίσεις και την προσαρμογή της συσκευής';
  ...
  @override
  String get yourOmiInsights => 'Οι Πληροφορίες σας στο FreeU';
  ...
  String get startConversationToSeeInsights =>
      'Ξεκινήστε μια συνομιλία με το FreeU\nγια να δείτε τις πληροφορίες χρήσης σας εδώ.';

  @override
  String get listening => 'Ακρόαση';

  @override
  String get listeningSubtitle => 'Συνολικός χρόνος που το FreeU έχει ακούσει ενεργά.';
  ...
  @override
  String get shareStatsMessage => 'Μοιράζομαι τα στατιστικά μου στο FreeU! (FreeU.me - ο πάντα ενεργός βοηθός AI σας)';

  @override
  String get sharePeriodToday => 'Σήμερα, το FreeU:';

  @override
  String get sharePeriodMonth => 'Αυτόν τον μήνα, το FreeU:';

  @override
  String get sharePeriodYear => 'Φέτος, το FreeU:';

  @override
  String get sharePeriodAllTime => 'Μέχρι τώρα, το FreeU:';
  ...
  @override
  String get omiDebugLog => 'Αρχείο εντοπισμού σφαλμάτων FreeU';
  ...
  @override
  String get exportedConversations => 'Εξαγωγή Συνομιλιών από το FreeU';
  ...
  String authAccessMessage(String appName) {
    return 'Θα χρειαστεί να εξουσιοδοτήσετε το FreeU να έχει πρόσβαση στα δεδομένα σας στο $appName. Αυτό θα ανοίξει το πρόγραμμα περιήγησής σας για πιστοποίηση.';
  }
  ...
  @override
  String get howShouldOmiCallYou => 'Πώς θα πρέπει να σας αποκαλεί το FreeU;';
  ...
  String authorizeOmiForTasks(String appName) {
    return 'Θα χρειαστεί να εξουσιοδοτήσετε το FreeU να δημιουργεί εργασίες στον λογαριασμό σας $appName. Αυτό θα ανοίξει το πρόγραμμα περιήγησής σας για πιστοποίηση.';
  }
  ...
  @override
  String get payYourSttProvider => 'Χρησιμοποιήστε ελεύθερα το FreeU. Πληρώνετε μόνο τον πάροχο STT σας απευθείας.';

  @override
  String get freeMinutesMonth => '1.200 δωρεάν λεπτά/μήνα συμπεριλαμβάνονται. Απεριόριστο με ';

  @override
  String get omiUnlimited => 'FreeU Απεριόριστο';
  ...
  String deviceUsesCodec(String device, String reason) {
    return '$device χρησιμοποιεί $reason. Θα χρησιμοποιηθεί το FreeU.';
  }

  @override
  String get omiTranscription => 'Απομαγνητοφώνηση FreeU';
  ...
  String get bluetoothNeeded =>
      'Το FreeU χρειάζεται Bluetooth για σύνδεση με τη φορητή σας συσκευή. Παρακαλώ ενεργοποιήστε το Bluetooth και δοκιμάστε ξανά.';
  ...
  @override
  String get backgroundActivityDesc => 'Επιτρέψτε στο FreeU να εκτελείται στο παρασκήνιο για καλύτερη σταθερότητα';
  ...
  @override
  String get lovingOmi => 'Αγαπάτε το FreeU;';
  ...
  String get speechProfileIntro =>
      'Το FreeU πρέπει να μάθει τους στόχους και τη φωνή σας. Θα μπορείτε να το τροποποιήσετε αργότερα.';
  ...
  @override
  String get connectOmiOmiGlass => 'Σύνδεση FreeU / OmiGlass';
  ...
  @override
  String get omiYourAiCompanion => 'FreeU – Ο Βοηθός AI σας';
  ...
  String get permissionGrantedNow =>
      'Η άδεια χορηγήθηκε! Τώρα:\n\nΑνοίξτε την εφαρμογή FreeU στο ρολόι σας και πατήστε \"Συνέχεια\" παρακάτω';
  ...
  @override
  String get clearMemoryTitle => 'Εκκαθάριση Μνήμης του FreeU';

  @override
  String get clearMemoryMessage =>
      'Είστε βέβαιοι ότι θέλετε να εκκαθαρίσετε τη μνήμη του FreeU; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.';

  @override
  String get clearMemoryButton => 'Εκκαθάριση μνήμης';

  @override
  String get memoryClearedSuccess => 'Η μνήμη του FreeU για εσάς έχει εκκαθαριστεί';
  ...
  String get translationNoticeMessage =>
      'Το FreeU μεταφράζει συνομιλίες στην κύρια γλώσσα σας. Ενημερώστε το ανά πάσα στιγμή στις Ρυθμίσεις → Προφίλ.';
  ...
  @override
  String get omiSyncsAudioFiles => 'Το FreeU στη συνέχεια συγχρονίζει τα αρχεία ήχου με τον διακομιστή';
  ...
  String get welcomeToOmiDescription =>
      'Καλώς ήρθατε στο FreeU! Ο AI σύντροφός σας είναι έτοιμος να σας βοηθήσει με συνομιλίες, εργασίες και πολλά άλλα.';

  @override
  String get startUsingOmi => 'Ξεκινήστε να χρησιμοποιείτε το FreeU';
  ...
  String get startCapturingConversations =>
      'Ξεκινήστε να καταγράφετε συνομιλίες με τη συσκευή FreeU για να τις δείτε εδώ.';
  ...
  String get noTasksForToday =>
      'Δεν υπάρχουν εργασίες για σήμερα.\\nΡωτήστε το FreeU για περισσότερες εργασίες ή δημιουργήστε χειροκίνητα.';
  ...
  @override
  String get buildSubmitCustomOmiApp => 'Κατασκευάστε και υποβάλετε την προσαρμοσμένη εφαρμογή FreeU σας';
  ...
  String get submitAppTermsAgreement =>
      'Υποβάλλοντας αυτήν την εφαρμογή, συμφωνώ με τους Όρους Υπηρεσίας και την Πολιτική Απορρήτου του FreeU AI';
  ...
  String get dataAccessWarning =>
      'Αυτή η εφαρμογή θα έχει πρόσβαση στα δεδομένα σας. Η FreeU AI δεν είναι υπεύθυνη για τον τρόπο χρήσης, τροποποίησης ή διαγραφής των δεδομένων σας από αυτήν την εφαρμογή';
  ...
  @override
  String get getOmiDevice => 'Αποκτήστε συσκευή FreeU';
  ...
  @override
  String get permanentlyRemoveAllMemories => 'Μόνιμη αφαίρεση όλων των μνημών από το FreeU';
  ...
  @override
  String get clearOmisMemory => 'Εκκαθάριση μνήμης του FreeU';

  @override
  String clearMemoryConfirmation(int count) {
    return 'Είστε σίγουροι ότι θέλετε να διαγράψετε τη μνήμη του FreeU; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί και θα διαγράψει μόνιμα όλες τις $count μνήμες.';
  }

  @override
  String get omisMemoryCleared => 'Η μνήμη του FreeU για εσάς έχει διαγραφεί';

  @override
  String get welcomeToOmi => 'Καλώς ήρθατε στο FreeU';
  ...
  String get selectPreferredLanguageForBestExperience =>
      'Επιλέξτε την προτιμώμενη γλώσσα σας για την καλύτερη εμπειρία FreeU';
  ...
  String get tellUsHowYouWouldLikeToBeAddressed =>
      'Πείτε μας πώς θα θέλατε να σας αποκαλούμε. Αυτό βοηθά στην εξατομίκευση της εμπειρίας FreeU.';
  ...
  String get enableFeaturesForBestExperience =>
      'Ενεργοποιήστε λειτουργίες για την καλύτερη εμπειρία FreeU στη συσκευή σας.';
  ...
  String get microphoneAccessDescription =>
      'Το FreeU χρειάζεται πρόσβαση στο μικρόφωνο για να εγγράφει τις συνομιλίες σας και να παρέχει μεταγραφές.';
  ...
  String get screenRecordingDescription =>
      'Το FreeU χρειάζεται άδεια εγγραφής οθόνης για να καταγράφει τον ήχο συστήματος από τις συναντήσεις σας που βασίζονται στον περιηγητή.';
  ...
  String get accessibilityDescription =>
      'Το FreeU χρειάζεται άδεια προσβασιμότητας για να ανιχνεύει πότε συμμετέχετε σε συναντήσεις Zoom, Meet ή Teams στον περιηγητή σας.';
  ...
  @override
  String get manageYourOmiPersona => 'Διαχειριστείτε την FreeU persona σας';

  @override
  String get voiceAndPeople => 'Φωνή & Άνθρωποι';

  @override
  String get teachOmiYourVoice => 'Μάθετε στο FreeU τη φωνή σας';

  @override
  String get tellOmiWhoSaidIt => 'Πείτε στο FreeU ποιος το είπε 🗣️';
  ...
  @override
  String get helpImproveOmiBySharing => 'Βοηθήστε στη βελτίωση του FreeU μοιράζοντας ανώνυμα δεδομένα ανάλυσης';
  ...
  String get mcpDescription =>
      'Για να συνδέσετε το FreeU με άλλες εφαρμογές για να διαβάσετε, να αναζητήσετε και να διαχειριστείτε τις αναμνήσεις και τις συνομιλίες σας. Δημιουργήστε ένα κλειδί για να ξεκινήσετε.';
  ...
  @override
  String get letOmiChooseAutomatically => 'Αφήστε το FreeU να επιλέξει αυτόματα την καλύτερη εφαρμογή';
  ...
  @override
  String get translatedByOmi => 'μεταφρασμένο από FreeU';
  ...
  @override
  String get addWordsDescription => 'Προσθέστε λέξεις που θα πρέπει να αναγνωρίζει το FreeU κατά τη μεταγραφή.';
  ...
  @override
  String get connectOmiWithAI => 'Συνδέστε το FreeU με βοηθούς AI';
  ...
  @override
  String get bySubmittingYouAgreeToOmi => 'Με την υποβολή, συμφωνείτε με το FreeU ';
  ...
  String get dataAccessNoticeDescription =>
      'Αυτή η εφαρμογή θα έχει πρόσβαση στα δεδομένα σας. Η FreeU AI δεν είναι υπεύθυνη για τον τρόπο χρήσης των δεδομένων σας από τρίτους.';
  ...
  @override
  String get omiApiKeys => 'Κλειδιά API FreeU';

  @override
  String get apiKeysDescription =>
      'Τα κλειδιά API χρησιμοποιούνται για έλεγχο ταυτότητας όταν η εφαρμογή σας επικοινωνεί με τον διακομιστή FreeU. Επιτρέπουν στην εφαρμογή σας να δημιουργεί αναμνήσεις και να έχει ασφαλή πρόσβαση σε άλλες υπηρεσίες FreeU.';

  @override
  String get aboutOmiApiKeys => 'Σχετικά με τα κλειδιά API FreeU';
  ...
  String get e2eeDescription =>
      'Η κρυπτογράφηση από άκρο σε άκρο είναι το χρυσό πρότυπο για την ιδιωτικότητα. Όταν είναι ενεργοποιημένη, τα δεδομένα σας κρυπτογραφούνται στη συσκευή σας πριν σταλούν στους διακομιστές μας. Αυτό σημαίνει ότι κανείς, ούτε καν η FreeU, δεν μπορεί να έχει πρόσβαση στο περιεχόμενό σας.';
  ...
  String get secureEncryptionDescription =>
      'Τα δεδομένα σας κρυπτογραφούνται με ένα μοναδικό κλειδί για εσάς στους διακομιστές μας, που φιλοξενούνται στο Google Cloud. Αυτό σημαίνει ότι το ακατέργαστο περιεχόμενό σας είναι απρόσιτο σε οποιονδήποτε, συμπεριλαμβανομένου του προσωπικού της FreeU ή της Google, απευθείας από τη βάση δεδομένων.';
  ...
  @override
  String get omiTraining => 'Εκπαίδευση FreeU';
  ...
  String get getOmiUnlimitedFree =>
      'Αποκτήστε το FreeU Unlimited δωρεάν συνεισφέροντας τα δεδομένα σας για την εκπαίδευση μοντέλων AI.';
  ...
  @override
  String get learnMoreAtOmiTraining => 'Μάθετε περισσότερα στο FreeU.me/training';
  ...
  @override
  String get yourOmiUnleashed => 'Το FreeU σας, απελευθερωμένο. Γίνετε απεριόριστοι για ατελείωτες δυνατότητες.';
  ...
  @override
  String get askOmiAnything => 'Ρωτήστε το FreeU οτιδήποτε για τη ζωή σας';

  @override
  String get unlockOmiInfiniteMemory => 'Ξεκλειδώστε την άπειρη μνήμη του FreeU';
  ...
  String get privacyIntroText =>
      'Στην FreeU, λαμβάνουμε πολύ σοβαρά το απόρρητό σας. Θέλουμε να είμαστε διαφανείς σχετικά με τα δεδομένα που συλλέγουμε και πώς τα χρησιμοποιούμε. Ορίστε τι πρέπει να γνωρίζετε:';
  ...
  String get commitmentText =>
      'Δεσμευόμαστε να χρησιμοποιούμε τα δεδομένα που συλλέγουμε μόνο για να κάνουμε το FreeU καλύτερο προϊόν για εσάς. Το απόρρητο και η εμπιστοσύνη σας είναι υψίστης σημασίας για εμάς.';

  @override
  String get thankYouText =>
      'Σας ευχαριστούμε που είστε πολύτιμος χρήστης του FreeU. Εάν έχετε ερωτήσεις ή ανησυχίες, μη διστάσετε να επικοινωνήσετε μαζί μας στο team@basedhardware.com.';
  ...
  @override
  String get omiHas => 'Το FreeU έχει:';
  ...
  String get howPeopleWorks =>
      'Μόλις δημιουργηθεί ένα άτομο, μπορείτε να μεταβείτε σε μια μεταγραφή συνομιλίας και να του αντιστοιχίσετε τα αντίστοιχα τμήματα, έτσι το FreeU θα μπορεί να αναγνωρίζει και τη δική του ομιλία!';
  ...
  @override
  String get installOmiOnAppleWatch => 'Εγκαταστήστε το FreeU στο\nApple Watch σας';

  @override
  String get installOmiOnAppleWatchDescription =>
      'Για να χρησιμοποιήσετε το Apple Watch με το FreeU, πρέπει πρώτα να εγκαταστήσετε την εφαρμογή FreeU στο ρολόι σας.';

  @override
  String get openOmiOnAppleWatch => 'Ανοίξτε το FreeU στο\nApple Watch σας';

  @override
  String get openOmiOnAppleWatchDescription =>
      'Η εφαρμογή FreeU είναι εγκατεστημένη στο Apple Watch σας. Ανοίξτε την και πατήστε Έναρξη.';
  ...
  String get unableToOpenWatchApp =>
      'Δεν είναι δυνατό το άνοιγμα της εφαρμογής Apple Watch. Ανοίξτε χειροκίνητα την εφαρμογή Watch στο Apple Watch και εγκαταστήστε το FreeU από την ενότητα \"Διαθέσιμες εφαρμογές\".';
  ...
  String get appleWatchNotReachable =>
      'Το Apple Watch δεν είναι ακόμα προσβάσιμο. Βεβαιωθείτε ότι η εφαρμογή FreeU είναι ανοιχτή στο ρολόι σας.';
  ...
  @override
  String get updateOmiFirmware => 'Ενημέρωση firmware FreeU';
  ...
  @override
  String get addVocabularyDescription => 'Προσθέστε λέξεις που το FreeU πρέπει να αναγνωρίζει κατά τη μεταγραφή.';
  ...
  @override
  String get wrappedOmiLifeRecap => 'Ανασκόπηση ζωής FreeU';

  @override
  String get wrappedSwipeUpToBegin => 'Σύρε προς τα πάνω για να ξεκινήσεις';

  @override
  String get wrappedShareText => 'Το 2025 μου, αποτυπωμένο από το FreeU ✨ FreeU.me/wrapped';
  ...
  @override
  String get wrappedRememberedByOmi => 'αποτυπωμένο από το FreeU';
  ...
  @override
  String get controlNotificationFrequency => 'Ελέγξτε πόσο συχνά το FreeU σας στέλνει προληπτικές ειδοποιήσεις.';
  ...
  String get notificationFrequencyDescription =>
      'Ελέγξτε πόσο συχνά το FreeU σας στέλνει προληπτικές ειδοποιήσεις και υπενθυμίσεις.';
  ...
  @override
  String get audioFromOmiWillAppearHere => 'Ο ήχος από τη συσκευή FreeU θα εμφανιστεί εδώ';
  ...
  @override
  String get considerOmiCloud => 'Σκεφτείτε να χρησιμοποιήσετε το FreeU Cloud για καλύτερη απόδοση.';
  ...
  String get omiTranscriptionOptimized =>
      'Η ενσωματωμένη ζωντανή μεταγραφή του FreeU είναι βελτιστοποιημένη για συνομιλίες σε πραγματικό χρόνο με αυτόματη ανίχνευση και διαχωρισμό ομιλητών.';
  ...
  @override
  String get setupQuestionsIntro => 'Βοηθήστε μας να βελτιώσουμε το FreeU απαντώντας σε μερικές ερωτήσεις. 🫶 💜';

  @override
  String get setupQuestionProfession => '1. Τι κάνετε;';

  @override
  String get setupQuestionUsage => '2. Πού σκοπεύετε να χρησιμοποιήσετε το FreeU;';
  ...
  @override
  String get getOmi => 'Αποκτήστε FreeU';

  @override
  String get iHaveOmiDevice => 'Έχω συσκευή FreeU';
  ...
  String get fastTransferDescription =>
      'Η γρήγορη μεταφορά χρησιμοποιεί WiFi για ~5x ταχύτερες ταχύτητες. Το τηλέφωνό σας θα συνδεθεί προσωρινά στο δίκτυο WiFi της συσκευής FreeU κατά τη μεταφορά.';
  ...
  String get chooseTransferMethodDescription =>
      'Επιλέξτε πώς μεταφέρονται οι εγγραφές από τη συσκευή FreeU στο τηλέφωνό σας.';
  ...
  String get fastTransferMethodDescription =>
      'Δημιουργεί απευθείας σύνδεση WiFi με τη συσκευή FreeU. Το τηλέφωνό σας αποσυνδέεται προσωρινά από το κανονικό WiFi κατά τη μεταφορά.';
  ...
  @override
  String get deviceDisconnectedNotificationTitle => 'Η συσκευή FreeU σας αποσυνδέθηκε';

  @override
  String get deviceDisconnectedNotificationBody =>
      'Παρακαλώ επανασυνδεθείτε για να συνεχίσετε να χρησιμοποιείτε το FreeU.';
  ...
  String firmwareUpdateAvailableDescription(String version) {
    return 'Μια νέα ενημέρωση υλικολογισμικού ($version) είναι διαθέσιμη για τη συσκευή FreeU σας. Θέλετε να ενημερώσετε τώρα;';
  }
  ...
  @override
  String get omiSays => 'το FreeU λέει';
  ...
  @override
  String get personaConnectKnowledgeSource => 'Συνδέστε τουλάχιστον μία πηγή δεδομένων (FreeU ή Twitter)';
  ...
  @override
  String get connectOmiDevice => 'Σύνδεση συσκευής FreeU';
  ...
  @override
  String get actionItemReminderTitle => 'Υπενθύμιση FreeU';
  ...
  @override
  String get onboardingWelcomeToOmi => 'Καλώς ήρθατε στο FreeU';
  ...
  @override
  String get pairingTitleOmi => 'Ενεργοποιήστε το FreeU';

  @override
  String get pairingDescOmi => 'Πατήστε παρατεταμένα τη συσκευή μέχρι να δονηθεί για να την ενεργοποιήσετε.';

  @override
  String get pairingTitleOmiDevkit => 'Θέστε το FreeU DevKit σε λειτουργία σύζευξης';
  ...
  @override
  String get pairingTitleOmiGlass => 'Ενεργοποιήστε το FreeU Glass';
  ...
  String get pairingDescAppleWatch =>
      'Εγκαταστήστε και ανοίξτε την εφαρμογή FreeU στο Apple Watch σας, μετά πατήστε Σύνδεση στην εφαρμογή.';
