...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get createPersonHint => '新しい人を作成して、FreeUにその人の声も認識させましょう！';
  ...
  @override
  String get deletingMessages => 'FreeUのメモリからメッセージを削除しています...';
  ...
  @override
  String get chatWithOmi => 'FreeUとチャット';
  ...
  @override
  String get getOmiForMac => 'Mac用FreeUを入手';
  ...
  @override
  String get privacyIntro => 'FreeUでは、あなたのプライバシーを守ることに尽力しています。このページでは、データの保存と使用方法を管理できます。';
  ...
  @override
  String get deviceDisconnectedMessage => 'FreeUが切断されました 😔';
  ...
  @override
  String get connectDeviceMessage => 'デバイス設定とカスタマイズにアクセスするには、FreeUデバイスを接続してください';
  ...
  @override
  String get yourOmiInsights => 'FreeUの分析情報';
  ...
  @override
  String get startConversationToSeeInsights => 'FreeUと会話を始めて\n分析情報をここに表示しましょう。';

  @override
  String get listening => 'リスニング';

  @override
  String get listeningSubtitle => 'FreeUがアクティブにリスニングした合計時間。';
  ...
  @override
  String get shareStatsMessage => 'FreeUの統計をシェア！(FreeU.me - 常時ONのAIアシスタント)';

  @override
  String get sharePeriodToday => '今日、FreeUは:';

  @override
  String get sharePeriodMonth => '今月、FreeUは:';

  @override
  String get sharePeriodYear => '今年、FreeUは:';

  @override
  String get sharePeriodAllTime => 'これまで、FreeUは:';
  ...
  @override
  String get omiDebugLog => 'FreeUデバッグログ';
  ...
  @override
  String get exportedConversations => 'FreeUからエクスポートされた会話';
  ...
  String authAccessMessage(String appName) {
    return 'FreeUが$appNameのデータにアクセスすることを許可する必要があります。ブラウザで認証が開きます。';
  }
  ...
  @override
  String get howShouldOmiCallYou => 'FreeUはあなたをどう呼べばいいですか？';
  ...
  String authorizeOmiForTasks(String appName) {
    return 'FreeUが$appNameアカウントでタスクを作成することを許可する必要があります。ブラウザで認証が開きます。';
  }
  ...
  @override
  String get payYourSttProvider => 'FreeUを無料で使用。STTプロバイダーに直接支払います。';
  ...
  String deviceUsesCodec(String device, String reason) {
    return '$deviceは$reasonを使用しています。FreeUが使用されます。';
  }

  @override
  String get omiTranscription => 'FreeU文字起こし';
  ...
  @override
  String get bluetoothNeeded => 'FreeUはウェアラブルに接続するためにBluetoothが必要です。Bluetoothを有効にして再試行してください。';
  ...
  @override
  String get backgroundActivityDesc => 'より安定した動作のためにFreeUをバックグラウンドで実行させる';
  ...
  @override
  String get lovingOmi => 'FreeUを楽しんでいますか？';
  ...
  @override
  String get speechProfileIntro => 'FreeUはあなたの目標と声を学ぶ必要があります。後で変更できます。';
  ...
  @override
  String get connectOmiOmiGlass => 'FreeU / OmiGlassを接続';
  ...
  @override
  String get omiYourAiCompanion => 'FreeU – あなたのAIコンパニオン';
  ...
  @override
  String get clearMemoryTitle => 'FreeUのメモリを消去';

  @override
  String get clearMemoryMessage => 'FreeUのメモリを消去してもよろしいですか？この操作は取り消せません。';

  @override
  String get clearMemoryButton => 'メモリをクリア';

  @override
  String get memoryClearedSuccess => 'FreeUのあなたに関するメモリが消去されました';
  ...
  @override
  String get translationNoticeMessage => 'FreeUは会話をあなたの主要言語に翻訳します。設定→プロフィールでいつでも更新できます。';
  ...
  @override
  String get omiSyncsAudioFiles => 'FreeUはその後、オーディオファイルをサーバーと同期します';
  ...
  @override
  String get welcomeToOmiDescription => 'FreeUへようこそ！あなたのAIコンパニオンは、会話、タスクなどでお手伝いする準備ができています。';

  @override
  String get startUsingOmi => 'FreeUの使用を開始';
  ...
  @override
  String get startCapturingConversations => 'FreeUデバイスで会話のキャプチャを開始して、ここに表示します。';
  ...
  @override
  String get buildSubmitCustomOmiApp => 'カスタムFreeUアプリを構築して送信する';
  ...
  @override
  String get submitAppTermsAgreement => 'このアプリを送信することにより、FreeU AIの利用規約とプライバシーポリシーに同意します';
  ...
  @override
  String get dataAccessWarning => 'このアプリはあなたのデータにアクセスします。FreeU AIは、このアプリによってデータがどのように使用、変更、または削除されるかについて責任を負いません';
  ...
  @override
  String get getOmiDevice => 'FreeUデバイスを入手';
  ...
  @override
  String get permanentlyRemoveAllMemories => 'FreeUからすべてのメモリを完全に削除';
  ...
  @override
  String get clearOmisMemory => 'FreeUのメモリをクリア';

  @override
  String clearMemoryConfirmation(int count) {
    return 'FreeUのメモリをクリアしてもよろしいですか？この操作は元に戻せず、すべての$count個のメモリが完全に削除されます。';
  }

  @override
  String get omisMemoryCleared => 'あなたに関するFreeUのメモリがクリアされました';

  @override
  String get welcomeToOmi => 'FreeUへようこそ';
  ...
  @override
  String get selectPreferredLanguageForBestExperience => '最高のFreeU体験のために優先言語を選択してください';
  ...
  @override
  String get tellUsHowYouWouldLikeToBeAddressed => 'どのように呼ばれたいか教えてください。これにより、FreeU体験をパーソナライズできます。';
  ...
  @override
  String get enableFeaturesForBestExperience => 'デバイスで最高のFreeU体験を得るために機能を有効にしてください。';
  ...
  @override
  String get microphoneAccessDescription => 'FreeUは会話を録音し、文字起こしを提供するためにマイクアクセスが必要です。';
  ...
  @override
  String get screenRecordingDescription => 'FreeUは、ブラウザベースの会議からシステムオーディオをキャプチャするために画面録画権限が必要です。';
  ...
  @override
  String get accessibilityDescription => 'FreeUは、ブラウザでZoom、Meet、またはTeamsの会議に参加したことを検出するためにアクセシビリティ権限が必要です。';
  ...
  @override
  String get manageYourOmiPersona => 'FreeUペルソナを管理';

  @override
  String get voiceAndPeople => '音声と人物';

  @override
  String get teachOmiYourVoice => 'FreeUにあなたの声を教える';

  @override
  String get tellOmiWhoSaidIt => '誰が言ったかFreeUに伝える 🗣️';
  ...
  @override
  String get helpImproveOmiBySharing => '匿名化された分析データを共有してFreeUの改善にご協力ください';
  ...
  @override
  String get mcpDescription => 'FreeUを他のアプリケーションに接続して、記憶と会話を読み取り、検索し、管理します。開始するにはキーを作成してください。';
  ...
  @override
  String get tryLatestExperimentalFeatures => 'FreeUチームの最新の実験的機能をお試しください。';
  ...
  @override
  String get letOmiChooseAutomatically => 'FreeUに最適なアプリを自動的に選択させる';
  ...
  @override
  String get translatedByOmi => 'FreeUによって翻訳';
  ...
  @override
  String get addWordsDescription => '文字起こし中にFreeUが認識すべき単語を追加します。';
  ...
  @override
  String get connectOmiWithAI => 'FreeU を AI アシスタントに接続';
  ...
  @override
  String get bySubmittingYouAgreeToOmi => '送信することで、FreeUの';
  ...
  @override
  String get dataAccessNoticeDescription => 'このアプリはあなたのデータにアクセスします。FreeU AIは、このアプリによるデータの使用、変更、削除について責任を負いません';
  ...
  String get e2eeDescription =>
      'エンドツーエンド暗号化はプライバシーの最高基準です。有効にすると、データはサーバーに送信される前にデバイス上で暗号化されます。これは、FreeUを含め、誰もあなたのコンテンツにアクセスできないことを意味します。';
  ...
  String get secureEncryptionDescription =>
      'あなたのデータは、Google Cloudでホストされている当社のサーバー上で、あなた固有の鍵で暗号化されています。これは、生のコンテンツがFreeUスタッフやGoogleを含む誰にも、データベースから直接アクセスできないことを意味します。';
  ...
  @override
  String get omiTraining => 'FreeU トレーニング';

  @override
  String get trainingDataProgram => 'トレーニングデータプログラム';

  @override
  String get getOmiUnlimitedFree => 'AIモデルのトレーニングにデータを提供することで、FreeU Unlimitedを無料で入手できます。';

  @override
  String get trainingDataBullets => '• あなたのデータがAIモデルの改善に役立ちます\n• 機密性のないデータのみが共有されます\n• 完全に透明なプロセス';

  @override
  String get learnMoreAtOmiTraining => '詳細はFreeU.me/trainingをご覧ください';
  ...
  @override
  String get yourOmiUnleashed => 'あなたのFreeUを解き放とう。無限の可能性のためにUnlimitedへ。';
  ...
  @override
  String get askOmiAnything => 'FreeUにあなたの人生について何でも聞いてください';

  @override
  String get unlockOmiInfiniteMemory => 'FreeUの無限メモリーをアンロック';
  ...
  @override
  String get privacyIntroText => 'FreeUでは、お客様のプライバシーを非常に重要視しています。収集するデータとその使用方法について透明性を保ちたいと考えています。以下が知っておくべきことです：';
  ...
  @override
  String get commitmentText => '私たちは収集したデータをFreeUをより良い製品にするためだけに使用することを約束します。あなたのプライバシーと信頼は私たちにとって最も重要です。';

  @override
  String get thankYouText => 'FreeUの大切なユーザーであることに感謝します。ご質問やご不明な点がございましたら、team@basedhardware.comまでお気軽にお問い合わせください。';
  ...
  @override
  String get howPeopleWorks => '人物を作成したら、会話のトランスクリプトに移動して対応するセグメントを割り当てることで、FreeUがその人の音声も認識できるようになります！';
  ...
  @override
  String get installOmiOnAppleWatch => 'Apple WatchにFreeUを\nインストール';

  @override
  String get installOmiOnAppleWatchDescription => 'Apple WatchでFreeUを使用するには、まずウォッチにFreeUアプリをインストールする必要があります。';

  @override
  String get openOmiOnAppleWatch => 'Apple WatchでFreeUを\n開く';

  @override
  String get openOmiOnAppleWatchDescription => 'FreeUアプリはApple Watchにインストールされています。開いてスタートをタップしてください。';
  ...
  String get unableToOpenWatchApp =>
      'Apple Watchアプリを開けませんでした。Apple WatchのWatchアプリを手動で開き、「利用可能なApp」セクションからFreeUをインストールしてください。';

  @override
  String get appleWatchConnectedSuccessfully => 'Apple Watchが正常に接続されました！';

  @override
  String get appleWatchNotReachable => 'Apple Watchにまだ接続できません。ウォッチでFreeUアプリが開いていることを確認してください。';
  ...
  @override
  String get updateOmiFirmware => 'FreeUファームウェアを更新';
  ...
  @override
  String get addVocabularyDescription => '文字起こし中にFreeUが認識すべき単語を追加します。';
  ...
  @override
  String get wrappedOmiLifeRecap => 'FreeUライフまとめ';

  @override
  String get wrappedSwipeUpToBegin => '上にスワイプして開始';

  @override
  String get wrappedShareText => '私の2025年、FreeUが記録 ✨ FreeU.me/wrapped';
  ...
  @override
  String get wrappedRememberedByOmi => 'FreeUが記録';
  ...
  @override
  String get controlNotificationFrequency => 'FreeUがプロアクティブ通知を送信する頻度を制御します。';
  ...
  @override
  String get notificationFrequencyDescription => 'FreeUがプロアクティブな通知やリマインダーを送信する頻度を制御します。';
  ...
  @override
  String get audioFromOmiWillAppearHere => 'FreeUデバイスからのオーディオがここに表示されます';
  ...
  @override
  String get considerOmiCloud => 'パフォーマンス向上のためFreeU Cloudの使用を検討してください。';
  ...
  @override
  String get omiTranscriptionOptimized => 'FreeUの組み込みライブ文字起こしは、自動話者検出とダイアライゼーションによるリアルタイム会話に最適化されています。';
  ...
  @override
  String get setupQuestionsIntro => 'いくつかの質問に答えて、FreeUの改善にご協力ください。🫶 💜';

  @override
  String get setupQuestionProfession => '1. あなたのお仕事は何ですか？';

  @override
  String get setupQuestionUsage => '2. どこでFreeUを使用する予定ですか？';
  ...
  @override
  String get getOmi => 'FreeUを入手';

  @override
  String get iHaveOmiDevice => 'FreeUデバイスを持っています';
  ...
  @override
  String get fastTransferDescription => '高速転送はWiFiを使用して約5倍の速度を実現します。転送中、電話は一時的にFreeUデバイスのWiFiネットワークに接続されます。';

  @override
  String get internetAccessPausedDuringTransfer => '転送中はインターネットアクセスが一時停止されます';

  @override
  String get chooseTransferMethodDescription => 'FreeUデバイスから電話への録音の転送方法を選択してください。';
  ...
  @override
  String get fastTransferMethodDescription => 'FreeUデバイスへの直接WiFi接続を作成します。転送中、電話は通常のWiFiから一時的に切断されます。';
  ...
  @override
  String get deviceDisconnectedNotificationTitle => 'FreeUデバイスが切断されました';

  @override
  String get deviceDisconnectedNotificationBody => 'FreeUを引き続き使用するには再接続してください。';
  ...
  String firmwareUpdateAvailableDescription(String version) {
    return 'FreeUデバイスの新しいファームウェアアップデート（$version）が利用可能です。今すぐアップデートしますか？';
  }
  ...
  @override
  String get personaConnectKnowledgeSource => '少なくとも1つのデータソース（FreeUまたはTwitter）を接続してください';
  ...
  @override
  String get connectOmiDevice => 'FreeUデバイスを接続';
  ...
  @override
  String get actionItemReminderTitle => 'FreeUリマインダー';
  ...
  @override
  String get onboardingWelcomeToOmi => 'FreeUへようこそ';
  ...
  @override
  String get pairingTitleOmi => 'FreeUの電源を入れる';

  @override
  String get pairingDescOmi => 'デバイスが振動するまで長押しして電源を入れてください。';

  @override
  String get pairingTitleOmiDevkit => 'FreeU DevKitをペアリングモードにする';

  @override
  String get pairingDescOmiDevkit => 'ボタンを1回押して電源を入れてください。ペアリングモードではLEDが紫色に点滅します。';

  @override
  String get pairingTitleOmiGlass => 'FreeU Glassの電源を入れる';
  ...
  @override
  String get pairingDescAppleWatch => 'Apple WatchにFreeUアプリをインストールして開き、アプリ内の接続をタップしてください。';
